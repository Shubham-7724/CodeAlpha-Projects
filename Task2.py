...
while ch.upper()=='Y':
    investor_name = str(input("Enter your name : "))
    ...
    if stock_name.upper() in stocks.keys():
        investment_value = stocks[stock_name.upper()] * stock_quantity
        print("Your investment value is : " , investment_value )

        with open("Investment_values.csv" , 'a') as F:
            writer = csv.writer(F)
